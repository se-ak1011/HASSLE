...
export const CONDITION_SYMPTOM_TAGS: Record<string, string[]> = {
  ...
  'Chronic pain': ['pain', 'flare', 'fatigue'],
  Arthritis: ['joint pain', 'stiffness', 'fatigue'],
  Dyslexia: ['reading fatigue', 'overwhelmed'],
  Dyspraxia: ['coordination', 'fatigue', 'overwhelmed'],
  'PTSD / trauma': ['triggered', 'hypervigilant', 'low mood'],
  OCD: ['intrusive thoughts', 'anxious'],
  'Sensory processing issues': ['overstimulated', 'sensory overload'],
