...
export const GARDEN_LAYOUT: Record<GardenAssetId, GardenLayoutItem> = {
  ...
  // Lola sits grounded on the open foreground grass (centre-ish), so she reads
  // as part of the scene rather than floating. Only one Lola is ever shown.
  lolaBuildSnowman: { id: 'lolaBuildSnowman', layer: 'lola', x: 0.56, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaHoldingPumpkin: { id: 'lolaHoldingPumpkin', layer: 'lola', x: 0.44, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaHoldingUmbrella: { id: 'lolaHoldingUmbrella', layer: 'lola', x: 0.47, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaJournaling: { id: 'lolaJournaling', layer: 'lola', x: 0.46, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaReadingBook: { id: 'lolaReadingBook', layer: 'lola', x: 0.46, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaListeningToMusic: { id: 'lolaListeningToMusic', layer: 'lola', x: 0.5, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaWateringFlowers: { id: 'lolaWateringFlowers', layer: 'lola', x: 0.39, y: 0.83, width: 0.15, anchor: 'bottomCenter' },
  lolaStargazing: { id: 'lolaStargazing', layer: 'lola', x: 0.5, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaWrappedInBlanket: { id: 'lolaWrappedInBlanket', layer: 'lola', x: 0.47, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaDrinkingCoffee: { id: 'lolaDrinkingCoffee', layer: 'lola', x: 0.46, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaPettingFox: { id: 'lolaPettingFox', layer: 'lola', x: 0.41, y: 0.83, width: 0.15, anchor: 'bottomCenter' },
  lolaHoldingRobin: { id: 'lolaHoldingRobin', layer: 'lola', x: 0.48, y: 0.82, width: 0.15, anchor: 'bottomCenter' },
  lolaLyingOnGrass: { id: 'lolaLyingOnGrass', layer: 'lola', x: 0.49, y: 0.85, width: 0.18, anchor: 'bottomCenter' },
};
