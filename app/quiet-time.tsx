...
function tileIcon(symbol: string) { return ({ leaf: 'eco', moon: 'bedtime', cup: 'local-cafe', book: 'menu-book', star: 'star-outline', stone: 'spa', rain: 'water-drop', flower: 'local-florist' } as Record<string, string>)[symbol] ?? 'spa'; }
